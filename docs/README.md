...
|---------|----------|------|------------|
| Anthropic API | ✅ Yes | ✅ $5 free | console.anthropic.com |
| Shopify Partner | ❌ Optional | ✅ Free | partners.shopify.com |
| Vercel | ❌ Deploy only | ✅ Free | vercel.com |
| Render | ❌ Deploy only | ✅ Free | render.com |
